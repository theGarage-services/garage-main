...
import { ROLE_TEMPLATES, type RoleTemplate } from '../types/team';
...
export function TestTeamMemberInvite({ onBack, onInviteComplete }: Readonly<TestTeamMemberInviteProps>) {
  ...
  const handleRoleTemplateChange = (template: RoleTemplate) => {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="p-8">
            ...
            <TestPermissionEditor
              ...
              roleTemplate={formData.roleTemplate as RoleTemplate}
            />
                ...
                {Object.entries(ROLE_TEMPLATES).map(([key, template]) => (
                  key !== 'custom' && (
                    <Card
                      ...
                      onClick={() => handleRoleTemplateChange(key as RoleTemplate)}
                    >

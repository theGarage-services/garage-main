    ...
    <div className="min-h-screen bg-gray-50 p-8">
        ...
        <Card className="mb-6 p-4 bg-amber-50 border-amber-200">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm">
                  You have <span className="font-medium">{stats.pendingApprovals}</span> pending approval{stats.pendingApprovals > 1 ? 's' : ''}
                </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            {stats.pendingInvites > 0 && (
              <Badge variant="destructive">{stats.pendingInvites} pending</Badge>
            )}
          </div>
          <h3 className="text-2xl mb-1">{stats.totalMembers}</h3>
        ...
        >
          ...
          <h3 className="text-2xl mb-1">{stats.activeJobs}</h3>
          <p className="text-sm text-gray-600">Active Job Postings</p>
          <p className="text-xs text-gray-500 mt-2">{stats.totalApplicants} total applicants</p>
        </Card>
        ...
        >
          ...
          <h3 className="text-2xl mb-1">{stats.departments}</h3>
        ...
        >
          ...
          <h3 className="text-2xl mb-1 text-green-600">+24%</h3>
          <p className="text-sm text-gray-600">Application Growth</p>
          <p className="text-xs text-gray-500 mt-2">vs last {selectedTimeframe}</p>
        </Card>
      </div>

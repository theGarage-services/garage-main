...
export function UpdateJobStatusModal({ job, onClose, onUpdate }: Readonly<UpdateJobStatusModalProps>) {
  const currentStatus = job.hiringStatus || {
    stage: 'open',
    positionsFilled: 0,
  ...
  const [formData, setFormData] = useState({
    ...
    positionsFilled: currentStatus.positionsFilled,
    plannedInterviewCount: currentStatus.plannedInterviewCount,
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-4">
              <Card className="p-4">
                ...
                <p className="text-2xl font-semibold text-gray-900">{currentStatus.applicationsCount}</p>
              </Card>
              <Card className="p-4">
                <p className="text-xs text-gray-600 mb-1">In Interviews</p>
                <p className="text-2xl font-semibold text-purple-600">{currentStatus.interviewCount}</p>
              </Card>
              <Card className="p-4">
                <p className="text-xs text-gray-600 mb-1">Total Positions</p>
                <p className="text-2xl font-semibold text-gray-900">{currentStatus.totalPositions}</p>
              </Card>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              How many of the {currentStatus.totalPositions} positions have been filled?
            </p>
          </div>
          ...
          {formData.stage === 'interviewing' && (
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Currently interviewing {currentStatus.interviewCount} of {formData.plannedInterviewCount} planned candidates
              </p>
            </div>
          )}

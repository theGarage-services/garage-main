...
import { Calendar, Clock, User, VideoIcon, FileText, MapPin, X, CheckCircle, Maximize2 } from 'lucide-react';
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto p-0">
        ...
        <div className="sticky bottom-0 bg-gray-50 border-t border-gray-200 p-6 rounded-b-lg flex gap-3">
          ...
          <Button
            ...
            disabled={!interviewData.type || !interviewData.stage || !interviewData.date || !interviewData.time}

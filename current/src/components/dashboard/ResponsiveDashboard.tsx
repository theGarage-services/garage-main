...
export function ResponsiveDashboard({ stats, children }: Readonly<ResponsiveDashboardProps>) {
  return (
...
function StatCard({ label, value, change, trend, icon }: Readonly<DashboardStats>) {
...
function QuickActionButton({ icon, label }: Readonly<{ icon: React.ReactNode; label: string }>) {
  return (
    <Button
      variant="ghost"
